 ...
 */
public class AlipayParkingParkinglotinfoCreateResult implements Result{
    private TradeStatus tradeStatus;

    private AlipayEcoMycarParkingParkinglotinfoCreateResponse response;

    public AlipayParkingParkinglotinfoCreateResult(AlipayEcoMycarParkingParkinglotinfoCreateResponse response){
